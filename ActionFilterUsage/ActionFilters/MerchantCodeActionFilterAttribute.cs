...
namespace ActionFilterUsage.ActionFilters
{
    public class MerchantCodeActionFilterAttribute:ActionFilterAttribute
    {
        public async override Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            // set  Data
            var baseRequest = context.ActionArguments.FirstOrDefault(i =>
                i.Value != null && typeof(MerchantBaseRequest).IsAssignableFrom(i.Value.GetType()));
            ...
            {
                if (Equals(!context.ActionArguments.ContainsKey(key)))
